...
class ImageHandler(FileMixin):
    ...
    def output_filename(self):
        original_name = os.path.splitext(os.path.basename(self.filename))[0]
        return f"{self.get_directory_name()}/{original_name}_sbs.hevc"
    ...
    def generate_depth_image(self):
        ...
        pipe = pipeline(
            ...
            # device="cuda"  # Explicitly tell pipeline to use CUDA
        )
